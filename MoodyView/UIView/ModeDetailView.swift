    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            if modeDetail.images.count > 1 {
                ...
                .onChange(of: modeDetail.changeIntervalHours) { updateWallpaperIfSelected() }
                .onChange(of: modeDetail.changeIntervalMinutes) { updateWallpaperIfSelected() }
                .onChange(of: modeDetail.changeIntervalSeconds) { updateWallpaperIfSelected() }
                .padding(.top)
            }
            ...
            .onChange(of: appState.selectedModeUpdated) {
                onToggleIsSelected()
                modeDetail = modeDetail
            }
        }
